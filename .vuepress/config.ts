...
const author = "前端大波";
const domain = "https://zhaoxiaozhao1.github.io";
const tags = ["程序员", "web前端", "计算机"];

export default defineConfig({
  title: "大波的Web开发之路",
  description: "多年积累的学习经验、详实的学习记录以及在项目实践中遇到的问题与解决方案",
  head: [
    // 站点图标
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "前端大波, web前端, web前端百科, Vue, 前端干货分享, 前端, 开发, 编程分享, 项目, IT, 求职, 面经",
      },
    ],
    // 百度统计
    [
      ...
      `
        ...
        (function() {
          ...
          hm.src = "https://hm.baidu.com/hm.js?a2e84efce2f2a4f49c8f2cd90896c996";
  ...
  themeConfig: {
    ...
    // GitHub 仓库位置
    repo: "zhaoxiaozhao1/zhaoxiaozhao1.github.io",
    docsBranch: "master",
